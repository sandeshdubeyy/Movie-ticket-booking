      ...
      <div className='group grid grid-cols-4 gap-4 md:gap-4 mt-8 max-w-3xl mx-auto'>
        {
          dummyTrailers.map((trailer)=>(
            <div onClick={()=>{   console.log("Clicked:", trailer.videoUrl); setCurrentTrailer(trailer) }} key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer'>
