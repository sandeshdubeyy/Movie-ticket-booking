...
import { ArrowBigDown, CheckIcon, DeleteIcon, StarIcon } from "lucide-react";
...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
          ...
          {nowPlayingMovies.map((movie) => (
            ...
            >
              ...
              {selectedMovie === movie.id && (
                <div className="absolute top-2 right-2 flex items-center justify-center bg-primary h-6 w-6 text-white">
      ...
      <button onClick={handleSubmit} disabled={addingShow} className="bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transisiton-all cursor-pointer">Add Show</button>
      {/* disabled */}
    </>
  ) : (
    <Loading />
